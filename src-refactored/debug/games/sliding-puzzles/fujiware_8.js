...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("You", "G00104", 6);
    design.setup("You", "G00014", 10);
    design.setup("You", "G00105", 7);
    design.setup("You", "G00015", 11);
    design.setup("You", "G01006", 12);
    design.setup("You", "G10006", 13);
    design.setup("You", "G00107", 14);
    design.setup("You", "G00017", 18);
    design.setup("You", "G00108", 15);
    design.setup("You", "G00018", 19);
    design.setup("You", "G01009", 16);
    design.setup("You", "G10009", 17);

    design.goal(0, "You", "R0110F1", [14]);
    design.goal(0, "You", "R1010F1", [15]);
    design.goal(0, "You", "R0101F1", [18]);
    design.goal(0, "You", "R1001F1", [19]);
}
...
Dagaz.View.configure = function(view) {
    ...
    view.defPiece("YouG00104", "You G00104");
    view.defPiece("YouG00014", "You G00014");
    view.defPiece("YouG00105", "You G00105");
    view.defPiece("YouG00015", "You G00015");
    view.defPiece("YouG01006", "You G01006");
    view.defPiece("YouG10006", "You G10006");
