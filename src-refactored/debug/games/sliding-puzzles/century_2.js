...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("You", "B00105", 5);
    design.setup("You", "B00015", 9);
    design.setup("You", "R0110F6", 6);
    design.setup("You", "R1010F6", 7);
    design.setup("You", "R0101F6", 10);
    design.setup("You", "R1001F6", 11);
    design.setup("You", "B00107", 8);
    design.setup("You", "B00017", 12);
    ...
    design.goal(0, "You", "R0110F6", [13]);
    design.goal(0, "You", "R1010F6", [14]);
    design.goal(0, "You", "R0101F6", [17]);
    design.goal(0, "You", "R1001F6", [18]);
}
