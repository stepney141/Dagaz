...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("West", "Wizard", 28);
    design.setup("West", "Dwarf", 37);
    design.setup("West", "Troll", 46);
    design.setup("East", "Stone", 44);
    design.setup("East", "Wizard", 52);
    design.setup("East", "Dwarf", 43);
    design.setup("East", "Troll", 34);
}
