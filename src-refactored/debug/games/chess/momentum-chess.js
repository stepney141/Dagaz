...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addMove(0, 1, [4, 4], 4);
    design.addMove(0, 2, [7], 7);
    design.addMove(0, 2, [3], 3);

    design.addPiece("Rook", 1, 500);
    design.addMove(1, 4, [4, 4], 4);
    design.addMove(1, 4, [2, 2], 2);
    ...
    design.addMove(3, 4, [7, 7], 7);
    design.addMove(3, 4, [6, 6], 6);
    design.addMove(3, 4, [3, 3], 3);
    design.addMove(3, 4, [5, 5], 5);

    design.addPiece("Queen", 4, 900);
    design.addMove(4, 4, [4, 4], 4);
    design.addMove(4, 4, [2, 2], 2);
    design.addMove(4, 4, [0, 0], 0);
    design.addMove(4, 4, [1, 1], 1);
    design.addMove(4, 4, [7, 7], 7);
    design.addMove(4, 4, [6, 6], 6);
    design.addMove(4, 4, [3, 3], 3);
    design.addMove(4, 4, [5, 5], 5);

    design.addPiece("King", 5, 20000);
    design.addMove(5, 6, [4], 4);
    design.addMove(5, 6, [2], 2);
    design.addMove(5, 6, [0], 0);
    design.addMove(5, 6, [1], 1);
    design.addMove(5, 6, [7], 7);
    design.addMove(5, 6, [6], 6);
    design.addMove(5, 6, [3], 3);
    design.addMove(5, 6, [5], 5);
