...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.checkVersion("koom-valley-extension", "true");
    design.checkVersion("koom-valley-goal", "true");
    ...
    design.addZone("goal", 1, [5, 6, 7, 8, 9]);
    ...
    design.addCommand(3, ZRF.LITERAL,	1);	// Dwarf
    ...
    design.addMove(2, 2, [4, 4, 4], 0);
    design.addMove(2, 2, [7, 7, 7], 0);
    design.addMove(2, 2, [0, 0, 0], 0);
    design.addMove(2, 2, [5, 5, 5], 0);
    design.addMove(2, 2, [1, 1, 1], 0);
    design.addMove(2, 2, [3, 3, 3], 0);
    design.addMove(2, 2, [2, 2, 2], 0);
    design.addMove(2, 2, [6, 6, 6], 0);
    design.addMove(2, 3, [4, 4], 1);
    design.addMove(2, 3, [7, 7], 1);
    design.addMove(2, 3, [0, 0], 1);
    design.addMove(2, 3, [5, 5], 1);
    design.addMove(2, 3, [1, 1], 1);
    design.addMove(2, 3, [3, 3], 1);
    design.addMove(2, 3, [2, 2], 1);
    design.addMove(2, 3, [6, 6], 1);
    ...
    design.setup("Dwarfs", "Dwarf", 127);
    design.setup("Dwarfs", "Rock", 112);
    design.setup("Trolls", "Troll", 34);
    design.setup("Trolls", "Troll", 35);
    design.setup("Trolls", "Troll", 20);
    design.setup("Trolls", "Troll", 22);
    design.setup("Trolls", "Troll", 37);
    design.setup("Trolls", "Troll", 24);
    design.setup("Trolls", "Troll", 39);
    design.setup("Trolls", "Troll", 40);
}

Dagaz.View.configure = function(view) {
    view.defBoard("Board");
    view.defPiece("DwarfsRock", "Dwarfs Rock");
