...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("White", "King", 49);
    design.setup("White", "King", 51);
    design.setup("White", "King", 53);
    design.setup("White", "King", 55);
    design.setup("White", "King", 40);
    design.setup("White", "King", 42);
    design.setup("White", "King", 44);
    design.setup("White", "King", 46);
    ...
    design.setup("Black", "King", 12);
    design.setup("Black", "King", 14);
    design.setup("Black", "King", 17);
    design.setup("Black", "King", 19);
    design.setup("Black", "King", 21);
