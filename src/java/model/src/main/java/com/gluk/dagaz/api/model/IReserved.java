...
public interface IReserved {
	...
	public final static String CMD_END          = "end";                 // Завершение расчёта хода
	public final static String CMD_JUMP         = "jump";                // Безусловный переход
	public final static String CMD_GET          = "get";                 // Запрос значения по имени
	public final static String CMD_DROP         = "drop";                // Удаление значения на стеке
	public final static String CMD_LOG          = "log";                 // Формирование нотации хода
	public final static String CMD_TRACE        = "trace";               // Трассировка
	public final static String CMD_ANY          = "any";                 // Недетерминированный выбор
	public final static String CMD_CHECK        = "check";               // Проверка выполнения инварианта
	public final static String CMD_IF           = "if";                  // Условный переход
	...
	public final static String CMD_DEL          = "del";                 // Удаление локальной переменной
	...
	public final static String CMD_PUT          = "put";                 // Возврат фигур на доску
