...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addMove(2, 6, [7, 4], 0);
    design.addMove(2, 6, [7, 0], 0);
    design.addMove(2, 6, [3, 4], 0);
    design.addMove(2, 6, [3, 1], 0);
    design.addMove(2, 6, [6, 2], 0);
    design.addMove(2, 6, [6, 0], 0);
    design.addMove(2, 6, [5, 2], 0);
    design.addMove(2, 6, [5, 1], 0);
    ...
    design.addMove(5, 8, [1, 1, 1, 0, 0], 0);
    design.addMove(5, 9, [0, 0, 0, 0, 1, 1, 1], 0);
    ...
    design.addMove(6, 6, [4, 4], 0);
    design.addMove(6, 6, [7, 7], 0);
    design.addMove(6, 6, [2, 2], 0);
    design.addMove(6, 6, [6, 6], 0);
    design.addMove(6, 6, [0, 0], 0);
    design.addMove(6, 6, [3, 3], 0);
    design.addMove(6, 6, [1, 1], 0);
    design.addMove(6, 6, [5, 5], 0);

    design.addPiece("Wizard", 7);
    design.addMove(7, 7, [7], 0);
    design.addMove(7, 7, [6], 0);
    design.addMove(7, 7, [3], 0);
    design.addMove(7, 7, [5], 0);
    design.addMove(7, 10, [4, 7, 4], 0);
    design.addMove(7, 10, [4, 3, 4], 0);
    design.addMove(7, 10, [2, 6, 2], 0);
    design.addMove(7, 10, [2, 5, 2], 0);
    design.addMove(7, 10, [0, 7, 0], 0);
    design.addMove(7, 10, [0, 6, 0], 0);
    design.addMove(7, 10, [1, 3, 1], 0);
    design.addMove(7, 10, [1, 5, 1], 0);
