...
Dagaz.AI.g_flags = moveflagPromoteKnight | moveflagPromoteQueen | moveflagPromoteBishop | moveflagCastleKing | moveflagCastleQueen | moveflagEPC;
...
Dagaz.AI.GenerateCaptureMoves = function(moveStack) {
    ...
    if (g_enPassentSquare != -1) {
        ...
        if ((Dagaz.AI.g_board[from] & 0xF) == pawn) {
