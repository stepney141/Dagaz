...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("White", "Min-gyi", 54);
    design.setup("White", "Sit-ke", 44);
    design.setup("White", "Yahhta", 58);
    design.setup("White", "Yahhta", 60);
    design.setup("White", "Myin", 53);
    design.setup("White", "Myin", 45);
    design.setup("White", "Sin", 51);
    design.setup("White", "Sin", 46);
    ...
    design.setup("Black", "Min-gyi", 10);
    design.setup("Black", "Sit-ke", 19);
    design.setup("Black", "Yahhta", 4);
    design.setup("Black", "Yahhta", 6);
    design.setup("Black", "Myin", 11);
    design.setup("Black", "Myin", 13);
    design.setup("Black", "Sin", 18);
    design.setup("Black", "Sin", 12);
}
