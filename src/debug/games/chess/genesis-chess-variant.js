...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addMove(5, 5, [4], 1);
    design.addMove(5, 5, [2], 1);
    design.addMove(5, 5, [0], 1);
    design.addMove(5, 5, [1], 1);
    design.addMove(5, 5, [7], 1);
    design.addMove(5, 5, [6], 1);
    design.addMove(5, 5, [3], 1);
    design.addMove(5, 5, [5], 1);

    design.reserve("White", "Pawn", 8);
