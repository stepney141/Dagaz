...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addCommand(0, ZRF.PROMOTE,	8);	// Queen
    ...
    design.addCommand(2, ZRF.PROMOTE,	8);	// Queen
    ...
    design.addCommand(7, ZRF.FUNCTION,	20);	// verify
    design.addCommand(7, ZRF.LITERAL,	2);	// Rook
    ...
    design.addCommand(8, ZRF.FUNCTION,	20);	// verify
    design.addCommand(8, ZRF.LITERAL,	2);	// Rook
...
Dagaz.View.configure = function(view) {
    ...
    view.defPiece("WhiteMirroredPawn", "White MirroredPawn");
    view.defPiece("BlackMirroredPawn", "Black MirroredPawn");
    view.defPiece("WhiteRook", "White Rook");
    view.defPiece("BlackRook", "Black Rook");
    view.defPiece("WhiteMirroredRook", "White MirroredRook");
    view.defPiece("BlackMirroredRook", "Black MirroredRook");
    view.defPiece("WhiteKnight", "White Knight");
    view.defPiece("BlackKnight", "Black Knight");
    view.defPiece("WhiteMirroredKnight", "White MirroredKnight");
    view.defPiece("BlackMirroredKnight", "Black MirroredKnight");
    view.defPiece("WhiteBishop", "White Bishop");
    view.defPiece("BlackBishop", "Black Bishop");
    view.defPiece("WhiteMirroredBishop", "White MirroredBishop");
    view.defPiece("BlackMirroredBishop", "Black MirroredBishop");
    view.defPiece("WhiteQueen", "White Queen");
    view.defPiece("BlackQueen", "Black Queen");
    view.defPiece("WhiteMirroredQueen", "White MirroredQueen");
    view.defPiece("BlackMirroredQueen", "Black MirroredQueen");
    view.defPiece("WhiteKing", "White King");
    view.defPiece("BlackKing", "Black King");
    view.defPiece("WhiteMirroredKing", "White MirroredKing");
    view.defPiece("BlackMirroredKing", "Black MirroredKing");
