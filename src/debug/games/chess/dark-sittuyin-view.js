...
Dagaz.Model.Done = function(design, board) {
  ...
  _.each(design.allPositions(), function(pos) {
      ...
      if (piece !== null) {
          ...
          if ((piece.type == 1) || (piece.type == 0) || (piece.type == 3)) {
          ...
          if (piece.type == 4) {
              ...
              checkJump(design, board, piece.player, pos, s, sw, visible);
              checkJump(design, board, piece.player, pos, s, se, visible);
              checkJump(design, board, piece.player, pos, w, nw, visible);
              checkJump(design, board, piece.player, pos, w, sw, visible);
              checkJump(design, board, piece.player, pos, e, ne, visible);
              checkJump(design, board, piece.player, pos, e, se, visible);
          }
          if (piece.type == 5) {
              checkStep(design, board, piece.player, pos, nw, visible);
              checkStep(design, board, piece.player, pos, ne, visible);
