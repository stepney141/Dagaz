...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("Black", "Min-gyi", 9);
    design.setup("Black", "Sit-ke", 19);
    design.setup("Black", "Yahhta", 3);
    design.setup("Black", "Yahhta", 5);
    design.setup("Black", "Myin", 10);
    design.setup("Black", "Myin", 18);
    design.setup("Black", "Sin", 17);
