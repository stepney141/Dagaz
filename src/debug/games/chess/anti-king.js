...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addPiece("BerolinaPawn", 0);
    ...
    design.addMove(5, 5, [4, 7], 1);
    design.addMove(5, 5, [4, 3], 1);
    design.addMove(5, 5, [2, 6], 1);
    design.addMove(5, 5, [2, 5], 1);
    design.addMove(5, 5, [0, 7], 1);
    design.addMove(5, 5, [0, 6], 1);
    design.addMove(5, 5, [1, 3], 1);
    design.addMove(5, 5, [1, 5], 1);

    design.addPiece("AntiKing", 6);
    ...
    design.addMove(6, 5, [4, 7], 1);
    design.addMove(6, 5, [4, 3], 1);
    design.addMove(6, 5, [2, 6], 1);
    design.addMove(6, 5, [2, 5], 1);
    design.addMove(6, 5, [0, 7], 1);
    design.addMove(6, 5, [0, 6], 1);
    design.addMove(6, 5, [1, 3], 1);
    design.addMove(6, 5, [1, 5], 1);

    design.setup("White", "BerolinaPawn", 40);
    design.setup("White", "BerolinaPawn", 41);
    design.setup("White", "BerolinaPawn", 42);
    design.setup("White", "BerolinaPawn", 43);
    design.setup("White", "BerolinaPawn", 44);
    design.setup("White", "BerolinaPawn", 45);
    design.setup("White", "BerolinaPawn", 53);
    design.setup("White", "BerolinaPawn", 61);
    design.setup("White", "Rook", 48);
    design.setup("White", "Rook", 60);
    design.setup("White", "Knight", 50);
    design.setup("White", "Knight", 51);
    design.setup("White", "Bishop", 49);
    design.setup("White", "Bishop", 59);
    design.setup("White", "Queen", 57);
    design.setup("White", "King", 58);
    design.setup("White", "AntiKing", 7);
    design.setup("Black", "BerolinaPawn", 2);
    design.setup("Black", "BerolinaPawn", 10);
    design.setup("Black", "BerolinaPawn", 18);
    design.setup("Black", "BerolinaPawn", 19);
    design.setup("Black", "BerolinaPawn", 20);
    design.setup("Black", "BerolinaPawn", 21);
    design.setup("Black", "BerolinaPawn", 22);
    design.setup("Black", "BerolinaPawn", 23);
    ...
    design.setup("Black", "AntiKing", 56);
}

Dagaz.View.configure = function(view) {
    view.defBoard("Board");
    view.defPiece("WhiteBerolinaPawn", "White BerolinaPawn");
    view.defPiece("BlackBerolinaPawn", "Black BerolinaPawn");
    ...
    view.defPiece("WhiteAntiKing", "White AntiKing");
    view.defPiece("BlackAntiKing", "Black AntiKing");
