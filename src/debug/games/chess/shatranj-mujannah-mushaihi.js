...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("Black", "Sarbaz", 8);
    design.setup("Black", "Sarbaz", 17);
    design.setup("Black", "Sarbaz", 18);
    design.setup("Black", "Sarbaz", 27);
    design.setup("Black", "Sarbaz", 28);
    design.setup("Black", "Sarbaz", 21);
    design.setup("Black", "Sarbaz", 14);
    design.setup("Black", "Sarbaz", 23);
    design.setup("Black", "Rokh", 0);
    design.setup("Black", "Rokh", 7);
    design.setup("Black", "Asb", 11);
    design.setup("Black", "Asb", 12);
    design.setup("Black", "Alfil", 2);
    design.setup("Black", "Alfil", 5);
    design.setup("Black", "Fers", 19);
    design.setup("Black", "Shah", 4);
}
