...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("White", "Sarbaz", 50);
    design.setup("White", "Sarbaz", 51);
    design.setup("White", "Sarbaz", 52);
    design.setup("White", "Sarbaz", 53);
    design.setup("White", "Sarbaz", 54);
    design.setup("White", "Sarbaz", 55);
    design.setup("White", "Rokh", 56);
    design.setup("White", "Rokh", 63);
    design.setup("White", "Asb", 57);
    design.setup("White", "Asb", 62);
    ...
    design.setup("Black", "Sarbaz", 9);
    design.setup("Black", "Sarbaz", 10);
    design.setup("Black", "Sarbaz", 11);
    design.setup("Black", "Sarbaz", 12);
    design.setup("Black", "Sarbaz", 13);
    design.setup("Black", "Sarbaz", 14);
    design.setup("Black", "Sarbaz", 15);
    design.setup("Black", "Rokh", 0);
    design.setup("Black", "Rokh", 7);
    design.setup("Black", "Asb", 1);
    design.setup("Black", "Asb", 6);
