...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addMove(1, 4, [4, 4], 2);
    design.addMove(1, 4, [5, 5], 2);
    design.addMove(1, 4, [6, 6], 2);
    design.addMove(1, 4, [7, 7], 2);
    design.addMove(1, 4, [0, 0], 3);
    design.addMove(1, 4, [1, 1], 3);
    design.addMove(1, 4, [2, 2], 3);
    design.addMove(1, 4, [3, 3], 3);

    design.addPiece("Rook", 2);
    design.addMove(2, 4, [0, 0], 3);
    design.addMove(2, 4, [1, 1], 3);
    design.addMove(2, 4, [2, 2], 3);
    design.addMove(2, 4, [3, 3], 3);

    design.setup("Gold", "Pawn", 135);
    design.setup("Gold", "Pawn", 143);
    design.setup("Gold", "Pawn", 151);
    design.setup("Gold", "Pawn", 159);
    design.setup("Gold", "Pawn", 167);
    design.setup("Gold", "Pawn", 175);
    design.setup("Gold", "Pawn", 183);
    design.setup("Gold", "Pawn", 191);
    design.setup("Gold", "Bishop", 71);
    design.setup("Gold", "Bishop", 79);
    design.setup("Gold", "Bishop", 87);
    design.setup("Gold", "Bishop", 95);
    design.setup("Gold", "Bishop", 103);
    design.setup("Gold", "Bishop", 111);
    design.setup("Gold", "Bishop", 119);
    design.setup("Gold", "Bishop", 127);
    design.setup("Gold", "Rook", 7);
    design.setup("Gold", "Rook", 15);
    design.setup("Gold", "Rook", 23);
    design.setup("Gold", "Rook", 31);
    design.setup("Gold", "Rook", 39);
    design.setup("Gold", "Rook", 47);
    design.setup("Gold", "Rook", 55);
    design.setup("Gold", "Rook", 63);
    design.setup("Silver", "Pawn", 128);
    design.setup("Silver", "Pawn", 136);
    design.setup("Silver", "Pawn", 144);
    design.setup("Silver", "Pawn", 152);
    design.setup("Silver", "Pawn", 160);
    design.setup("Silver", "Pawn", 168);
    design.setup("Silver", "Pawn", 176);
    design.setup("Silver", "Pawn", 184);
    design.setup("Silver", "Bishop", 64);
    design.setup("Silver", "Bishop", 72);
    design.setup("Silver", "Bishop", 80);
    design.setup("Silver", "Bishop", 88);
    design.setup("Silver", "Bishop", 96);
    design.setup("Silver", "Bishop", 104);
    design.setup("Silver", "Bishop", 112);
    design.setup("Silver", "Bishop", 120);
    design.setup("Silver", "Rook", 0);
    design.setup("Silver", "Rook", 8);
    design.setup("Silver", "Rook", 16);
    design.setup("Silver", "Rook", 24);
    design.setup("Silver", "Rook", 32);
    design.setup("Silver", "Rook", 40);
    design.setup("Silver", "Rook", 48);
    design.setup("Silver", "Rook", 56);
}
