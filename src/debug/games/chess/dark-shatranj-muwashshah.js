...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("White", "Sarbaz", 41);
    design.setup("White", "Sarbaz", 42);
    design.setup("White", "Sarbaz", 35);
    design.setup("White", "Sarbaz", 44);
    design.setup("White", "Sarbaz", 29);
    design.setup("White", "Sarbaz", 38);
    design.setup("White", "Sarbaz", 55);
    design.setup("White", "Rokh", 57);
    design.setup("White", "Rokh", 62);
    design.setup("White", "Asb", 51);
    design.setup("White", "Asb", 45);
    ...
    design.setup("Black", "Sarbaz", 34, 1);
    ...
    design.setup("Black", "Sarbaz", 30, 6);
    design.setup("Black", "Rokh", 14, 6);
    design.setup("Black", "Rokh", 7, 6);
    design.setup("Black", "Asb", 11, 6);
    design.setup("Black", "Asb", 22, 6);
