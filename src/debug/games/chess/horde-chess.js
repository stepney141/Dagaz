...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addMove(2, 5, [4, 7], 0);
    design.addMove(2, 5, [4, 3], 0);
    design.addMove(2, 5, [2, 6], 0);
    design.addMove(2, 5, [2, 5], 0);
    design.addMove(2, 5, [0, 7], 0);
    design.addMove(2, 5, [0, 6], 0);
    design.addMove(2, 5, [1, 3], 0);
    design.addMove(2, 5, [1, 5], 0);
    ...
    design.setup("Black", "Pawn", 0, 1);
    design.setup("Black", "Pawn", 1, 1);
    design.setup("Black", "Pawn", 2, 1);
    ...
    design.setup("Black", "Pawn", 16, 1);
    design.setup("Black", "Pawn", 17, 1);
    design.setup("Black", "Pawn", 18, 1);
    design.setup("Black", "Pawn", 19, 1);
    design.setup("Black", "Pawn", 20, 1);
    ...
    design.setup("Black", "Pawn", 29, 1);
    design.setup("Black", "Pawn", 30, 1);
    design.setup("Black", "Pawn", 31, 1);
    design.setup("Black", "Pawn", 35, 1);
    design.setup("Black", "Pawn", 36, 1);

    design.setup("Black", "Pawn", 0, 2);
    design.setup("Black", "Pawn", 1, 2);
    design.setup("Black", "Pawn", 2, 2);
    design.setup("Black", "Pawn", 3, 2);
    design.setup("Black", "Pawn", 4, 2);
    ...
    design.setup("Black", "Pawn", 16, 2);
    design.setup("Black", "Pawn", 17, 2);
    design.setup("Black", "Pawn", 18, 2);
    design.setup("Black", "Pawn", 19, 2);
    design.setup("Black", "Pawn", 20, 2);
    design.setup("Black", "Pawn", 21, 2);
    design.setup("Black", "Pawn", 22, 2);
    design.setup("Black", "Pawn", 23, 2);
    design.setup("Black", "Pawn", 24, 2);
    design.setup("Black", "Pawn", 25, 2);
    design.setup("Black", "Pawn", 26, 2);
    design.setup("Black", "Pawn", 27, 2);
    design.setup("Black", "Pawn", 28, 2);
    design.setup("Black", "Pawn", 29, 2);
    design.setup("Black", "Pawn", 30, 2);
    design.setup("Black", "Pawn", 31, 2);
    design.setup("Black", "Pawn", 33, 2);
    design.setup("Black", "Pawn", 34, 2);
    design.setup("Black", "Pawn", 37, 2);
    design.setup("Black", "Pawn", 38, 2);
}
