...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addPlayer("Off", []);
    design.addTurn(1);

    design.addPosition("a7", []);
    design.addPosition("b7", []);
    design.addPosition("c7", []);
    design.addPosition("d7", []);
    design.addPosition("e7", []);
    design.addPosition("f7", []);
    design.addPosition("g7", []);
