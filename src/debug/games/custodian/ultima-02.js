...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("White", "Immobilizer", 21);
    design.setup("White", "LongLeaper", 56);
    design.setup("White", "LongLeaper", 25);
    design.setup("White", "Withdrawer", 44);
    design.setup("White", "King", 63);
    design.setup("Black", "Pawn", 42);
    design.setup("Black", "Pawn", 3);
    design.setup("Black", "Pawn", 29);
    design.setup("Black", "LongLeaper", 49);
    design.setup("Black", "King", 28);
}
