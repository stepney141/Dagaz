...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("White", "Pawn", 4);
    design.setup("White", "Pawn", 54);
    design.setup("White", "Coordinator", 39);
    design.setup("White", "LongLeaper", 61);
    design.setup("White", "LongLeaper", 55);
    design.setup("White", "Chameleon", 45);
    design.setup("White", "Chameleon", 31);
    design.setup("White", "King", 18);
    design.setup("Black", "Pawn", 49);
    design.setup("Black", "Immobilizer", 46);
