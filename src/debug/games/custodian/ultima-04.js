...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("White", "Immobilizer", 19);
    design.setup("White", "LongLeaper", 15);
    design.setup("White", "Chameleon", 38);
    design.setup("White", "Withdrawer", 29);
    design.setup("White", "King", 48);
    design.setup("Black", "Pawn", 2);
    design.setup("Black", "Pawn", 30);
    design.setup("Black", "LongLeaper", 12);
    design.setup("Black", "Chameleon", 13);
    design.setup("Black", "Withdrawer", 34);
