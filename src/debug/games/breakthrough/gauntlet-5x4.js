...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addPosition("a4", [0, 1, 5, 0]);
    design.addPosition("b4", [-1, 1, 5, 0]);
    design.addPosition("c4", [-1, 1, 5, 0]);
    design.addPosition("d4", [-1, 1, 5, 0]);
    design.addPosition("e4", [-1, 0, 5, 0]);
    ...
    design.setup("White", "Runner", 16);
    design.setup("White", "Runner", 17);
    design.setup("White", "Runner", 18);
    design.setup("Black", "Left", 10);
    design.setup("Black", "Left", 5);
    design.setup("Black", "Right", 14);
    design.setup("Black", "Right", 9);
...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a4", 2, 2, 80, 80);
    view.defPosition("b4", 82, 2, 80, 80);
    view.defPosition("c4", 162, 2, 80, 80);
    view.defPosition("d4", 242, 2, 80, 80);
    view.defPosition("e4", 322, 2, 80, 80);
    view.defPosition("a3", 2, 82, 80, 80);
    view.defPosition("b3", 82, 82, 80, 80);
    view.defPosition("c3", 162, 82, 80, 80);
    view.defPosition("d3", 242, 82, 80, 80);
    view.defPosition("e3", 322, 82, 80, 80);
    view.defPosition("a2", 2, 162, 80, 80);
    view.defPosition("b2", 82, 162, 80, 80);
    view.defPosition("c2", 162, 162, 80, 80);
    view.defPosition("d2", 242, 162, 80, 80);
    view.defPosition("e2", 322, 162, 80, 80);
    view.defPosition("a1", 2, 242, 80, 80);
    view.defPosition("b1", 82, 242, 80, 80);
    view.defPosition("c1", 162, 242, 80, 80);
    view.defPosition("d1", 242, 242, 80, 80);
    view.defPosition("e1", 322, 242, 80, 80);
}
