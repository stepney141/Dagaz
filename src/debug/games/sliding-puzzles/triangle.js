...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addPosition("c3", [0, 0, 2, 1, -6, 8, 6, 0]);
    design.addPosition("d3", [-1, 0, 0, 1, 0, 8, 6, 0]);
    design.addPosition("e3", [-1, -2, 0, 0, 0, 8, 6, -8]);
    design.addPosition("f3", [0, 0, 0, 0, 0, 0, 0, 0]);
    design.addPosition("g3", [0, 0, 0, 0, 0, 0, 0, 0]);
    design.addPosition("a2", [0, 0, 0, 0, 0, 0, 0, 0]);
    design.addPosition("b2", [0, 0, 2, 1, -6, 8, 6, 0]);
    design.addPosition("c2", [-1, 0, 2, 1, -6, 8, 6, 0]);
    design.addPosition("d2", [-1, -2, 2, 1, -6, 8, 6, -8]);
    design.addPosition("e2", [-1, -2, 0, 1, 0, 8, 6, -8]);
    design.addPosition("f2", [-1, -2, 0, 0, 0, 8, 6, -8]);
    design.addPosition("g2", [0, 0, 0, 0, 0, 0, 0, 0]);
    design.addPosition("a1", [0, 0, 2, 1, -6, 0, 0, 0]);
    design.addPosition("b1", [-1, 0, 2, 1, -6, 0, 0, 0]);
    design.addPosition("c1", [-1, -2, 2, 1, -6, 0, 0, -8]);
    design.addPosition("d1", [-1, -2, 2, 1, -6, 0, 0, -8]);
    design.addPosition("e1", [-1, -2, 2, 1, -6, 0, 0, -8]);
    design.addPosition("f1", [-1, -2, 0, 1, 0, 0, 0, -8]);
    design.addPosition("g1", [-1, -2, 0, 0, 0, 0, 0, -8]);
