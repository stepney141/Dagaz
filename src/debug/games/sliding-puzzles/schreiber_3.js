...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("You", "B00012", 6);
    design.setup("You", "B00003", 3);
    design.setup("You", "B00004", 7);
    design.setup("You", "B00105", 8);
    design.setup("You", "B00015", 12);
    ...
    design.goal(0, "You", "R0110F1", [13]);
    design.goal(0, "You", "R1010F1", [14]);
    design.goal(0, "You", "R0101F1", [17]);
    design.goal(0, "You", "R1001F1", [18]);
}
