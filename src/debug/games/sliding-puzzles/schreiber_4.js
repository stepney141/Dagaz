...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("You", "B01004", 9);
    design.setup("You", "B10004", 10);
    design.setup("You", "B01005", 12);
    design.setup("You", "B10005", 13);
    design.setup("You", "B00006", 14);
    design.setup("You", "B00007", 15);
    design.setup("You", "B00008", 16);
    design.setup("You", "B00009", 17);
