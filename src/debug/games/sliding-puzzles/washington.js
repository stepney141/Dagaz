...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("You", "B00003", 0);
    design.setup("You", "B01004", 1);
    design.setup("You", "B10004", 4);
    design.setup("You", "B01005", 5);
    design.setup("You", "B10005", 6);
    design.setup("You", "R0110F6", 7);
    design.setup("You", "R1010F6", 2);
    design.setup("You", "R0101F6", 12);
    design.setup("You", "R1001F6", 3);
    design.setup("You", "B01007", 4);
    design.setup("You", "B10007", 9);
    design.setup("You", "B00108", 10);
    design.setup("You", "B00018", 15);
    design.setup("You", "B00109", 11);
    design.setup("You", "B00019", 16);
    design.setup("You", "B001010", 5);
    design.setup("You", "B000110", 6);
    design.setup("You", "B001011", 14);
    design.setup("You", "B000111", 19);
    design.setup("You", "B000012", 17);
    design.setup("You", "B000013", 7);
    design.setup("You", "B010014", 20);
    design.setup("You", "B100014", 21);
    design.setup("You", "B010015", 8);
    design.setup("You", "B100015", 24);

    design.goal(0, "You", "R0110F6", [0]);
    design.goal(0, "You", "R1010F6", [1]);
    design.goal(0, "You", "R0101F6", [5]);
    design.goal(0, "You", "R1001F6", [6]);
}
