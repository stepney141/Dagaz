...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addPiece("R0110F6", 6);
    design.addAttribute(6, 0, 6);
    ...
    design.addPiece("G01008", 12);
    design.addAttribute(12, 0, 8);
    ...
    design.setup("You", "B00004", 3);
    design.setup("You", "G00105", 4);
    design.setup("You", "G00015", 8);
    design.setup("You", "R0110F6", 5);
    design.setup("You", "R1010F6", 6);
    design.setup("You", "R0101F6", 9);
    design.setup("You", "R1001F6", 10);
    design.setup("You", "G00107", 7);
    design.setup("You", "G00017", 11);
    design.setup("You", "G01008", 12);
    design.setup("You", "G10008", 13);
    design.setup("You", "G01009", 14);
    design.setup("You", "G10009", 15);
    design.setup("You", "G010010", 17);
    design.setup("You", "G100010", 18);

    design.goal(0, "You", "R0110F6", [1]);
    design.goal(0, "You", "R1010F6", [2]);
...
Dagaz.View.configure = function(view) {
    ...
    view.defPiece("YouG01008", "You G01008");
    view.defPiece("YouG10008", "You G10008");
    view.defPiece("YouG01009", "You G01009");
    view.defPiece("YouG10009", "You G10009");
    view.defPiece("YouG010010", "You G010010");
    view.defPiece("YouG100010", "You G100010");
