...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("You", "B00008", 14);
    design.setup("You", "B00009", 15);
    design.setup("You", "B000010", 18);
    design.setup("You", "B000011", 19);
    design.setup("You", "B000012", 20);
    design.setup("You", "B010013", 21);
    design.setup("You", "B001113", 22);
    design.setup("You", "B100013", 23);
    design.setup("You", "B010014", 24);
    design.setup("You", "B100014", 25);
    design.setup("You", "B001015", 26);
    design.setup("You", "B000115", 32);
    design.setup("You", "B001016", 27);
    design.setup("You", "B000116", 33);
    design.setup("You", "B010017", 28);
    design.setup("You", "B100017", 29);
    design.setup("You", "B010018", 30);
    design.setup("You", "B100018", 31);
    design.setup("You", "B010019", 34);
    design.setup("You", "B100019", 35);
...
Dagaz.View.configure = function(view) {
    ...
    view.defPiece("YouB001113", "You B001113");
    ...
    view.defPiece("YouB001016", "You B001016");
    view.defPiece("YouB000116", "You B000116");
