...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("You", "G00103", 3);
    design.setup("You", "G00013", 7);
    design.setup("You", "B00004", 4);
    design.setup("You", "R0110F5", 5);
    design.setup("You", "R1010F5", 6);
    design.setup("You", "R0101F5", 9);
    design.setup("You", "R1001F5", 10);
    design.setup("You", "G00106", 8);
    design.setup("You", "G00016", 12);
    design.setup("You", "B00007", 11);
    design.setup("You", "B00008", 13);
    design.setup("You", "G01009", 14);
    design.setup("You", "G10009", 15);
    design.setup("You", "G010010", 17);
    design.setup("You", "G100010", 18);

    design.goal(0, "You", "R0110F5", [6]);
    design.goal(0, "You", "R1010F5", [7]);
    design.goal(0, "You", "R0101F5", [10]);
    design.goal(0, "You", "R1001F5", [11]);
}
