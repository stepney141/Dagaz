...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("You", "R0110F3", 4);
    design.setup("You", "R1010F3", 5);
    design.setup("You", "R0101F3", 8);
    design.setup("You", "R1001F3", 9);
    design.setup("You", "B00004", 6);
    design.setup("You", "B00105", 7);
    design.setup("You", "B00015", 11);
    design.setup("You", "B00006", 10);
    design.setup("You", "B00107", 12);
    design.setup("You", "B00017", 16);
    design.setup("You", "B00008", 13);
    design.setup("You", "B00009", 14);
    design.setup("You", "B000010", 15);
    design.setup("You", "B000011", 19);

    design.goal(0, "You", "R0110F3", [1]);
    design.goal(0, "You", "R1010F3", [2]);
    design.goal(0, "You", "R0101F3", [5]);
    design.goal(0, "You", "R1001F3", [6]);
}
...
Dagaz.View.configure = function(view) {
    ...
    view.defPiece("YouR0110F3", "You R0110F3");
    view.defPiece("YouR1010F3", "You R1010F3");
    view.defPiece("YouR0101F3", "You R0101F3");
    view.defPiece("YouR1001F3", "You R1001F3");
