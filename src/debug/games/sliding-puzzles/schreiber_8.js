...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("You", "B01006", 10);
    design.setup("You", "B10006", 11);
    design.setup("You", "B00107", 14);
    design.setup("You", "B00017", 18);
    design.setup("You", "B00108", 15);
    design.setup("You", "B00018", 19);
    design.setup("You", "B00109", 16);
    design.setup("You", "B00019", 17);
