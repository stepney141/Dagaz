...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("Light", "YBD", 94);
    design.setup("Light", "BYB", 95);
    design.setup("Light", "GYB", 93);
    design.setup("Light", "YGD", 96);
    design.setup("Light", "BGB", 92);
    design.setup("Light", "GBD", 97);
    ...
    design.setup("Dark", "RD", 4);
    design.setup("Dark", "RB", 5);
    design.setup("Dark", "GRB", 3);
    design.setup("Dark", "RGD", 6);
    design.setup("Dark", "BGD", 2);
    design.setup("Dark", "GBB", 7);
}
