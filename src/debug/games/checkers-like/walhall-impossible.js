...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("Dark", "JotunnA", 25);
    design.setup("Dark", "JotunnA", 26);
    design.setup("Dark", "JotunnA", 27);
    design.setup("Dark", "JotunnA", 28);
    design.setup("Dark", "JotunnA", 29);
    design.setup("Dark", "JotunnA", 30);
