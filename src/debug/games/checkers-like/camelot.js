...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addPosition("b16", [0, 0, 0, 1, 0, 0, 0, 0]);
    design.addPosition("c16", [0, 0, 0, 1, -1, 0, 0, 0]);
    design.addPosition("d16", [0, 0, 0, 1, -1, 0, 0, 0]);
    design.addPosition("e16", [13, 0, 0, 1, -1, 0, 0, 0]);
    design.addPosition("f16", [13, 12, 0, 1, -1, 0, 0, 0]);
    design.addPosition("g16", [0, 12, 11, 1, -1, 0, 0, 0]);
    design.addPosition("h16", [0, 0, 11, 1, -1, 0, 0, 0]);
    design.addPosition("i16", [0, 0, 0, 1, -1, 0, 0, 0]);
    design.addPosition("j16", [0, 0, 0, 1, -1, 0, 0, 0]);
    design.addPosition("k16", [0, 0, 0, 0, -1, 0, 0, 0]);
    ...
    design.addPosition("f15", [13, 12, 11, 1, 0, -11, -13, -12]);
    design.addPosition("g15", [13, 12, 11, 0, -1, -11, -13, -12]);
    design.addPosition("h15", [0, 0, 0, 0, 0, 0, 0, 0]);
    design.addPosition("i15", [0, 0, 0, 0, 0, 0, 0, 0]);
    design.addPosition("j15", [0, 0, 0, 0, 0, 0, 0, 0]);
    ...
    design.addPosition("c14", [13, 12, 11, 1, 0, 0, 0, 0]);
    design.addPosition("d14", [13, 12, 11, 1, -1, 0, 0, 0]);
    design.addPosition("e14", [13, 12, 11, 1, -1, -11, 0, 0]);
    design.addPosition("f14", [13, 12, 11, 1, -1, -11, 0, -12]);
    design.addPosition("g14", [13, 12, 11, 1, -1, 0, -13, -12]);
    design.addPosition("h14", [13, 12, 11, 1, -1, 0, -13, 0]);
    design.addPosition("i14", [13, 12, 11, 1, -1, 0, 0, 0]);
    design.addPosition("j14", [13, 12, 11, 0, -1, 0, 0, 0]);
    design.addPosition("k14", [0, 0, 0, 0, 0, 0, 0, 0]);
    design.addPosition("l14", [0, 0, 0, 0, 0, 0, 0, 0]);
    design.addPosition("a13", [13, 12, 0, 1, 0, 0, 0, 0]);
    design.addPosition("b13", [13, 12, 11, 1, -1, -11, 0, 0]);
    design.addPosition("c13", [13, 12, 11, 1, -1, -11, 0, -12]);
    ...
    design.addPosition("j13", [13, 12, 11, 1, -1, 0, -13, -12]);
    design.addPosition("k13", [13, 12, 11, 1, -1, 0, -13, 0]);
    design.addPosition("l13", [0, 12, 11, 0, -1, 0, 0, 0]);
