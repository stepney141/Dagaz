...
//  design.addPriority(1);			// normal-type
    ...
    design.setup("Black", "Bishop", 90);
    design.setup("Black", "King", 92);
    design.setup("Black", "King", 96);
    design.setup("Black", "Camel", 98);
    design.setup("Black", "Queen", 94);
    design.setup("Black", "Dragon", 81);
    design.setup("Black", "Dragon", 83);
    design.setup("Black", "Dragon", 85);
    design.setup("Black", "Dragon", 87);
