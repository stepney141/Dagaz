...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addCommand(2, ZRF.MODE,	0);	// jumptype
...
Dagaz.View.configure = function(view) {
    ...
    view.addPiece("White Man", 48);
    view.addPiece("White Man", 49);
    view.addPiece("White Man", 50);
    view.addPiece("White Man", 51);
    view.addPiece("White Man", 52);
    view.addPiece("White Man", 53);
    view.addPiece("White Man", 54);
    view.addPiece("White Man", 55);
    view.addPiece("White Man", 40);
    view.addPiece("White Man", 41);
    view.addPiece("White Man", 42);
    view.addPiece("White Man", 43);
    view.addPiece("White Man", 44);
    view.addPiece("White Man", 45);
    view.addPiece("White Man", 46);
    view.addPiece("White Man", 47);
    view.addPiece("Black Man", 8);
    view.addPiece("Black Man", 9);
    view.addPiece("Black Man", 10);
    view.addPiece("Black Man", 11);
    view.addPiece("Black Man", 12);
    view.addPiece("Black Man", 13);
    view.addPiece("Black Man", 14);
    view.addPiece("Black Man", 15);
    view.addPiece("Black Man", 16);
    view.addPiece("Black Man", 17);
    view.addPiece("Black Man", 18);
    view.addPiece("Black Man", 19);
    view.addPiece("Black Man", 20);
    view.addPiece("Black Man", 21);
    view.addPiece("Black Man", 22);
    view.addPiece("Black Man", 23);
}
