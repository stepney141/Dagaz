...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addPosition("c7", [0, 1, 2, 3, 4, 5, 6, 7, 8]);
    design.addPosition("d7", [0, 3, -3, 7, 7, 0, 0, 0, 0]);
    design.addPosition("e7", [0, 1, 2, 3, 4, 5, 6, 7, 8]);
    design.addPosition("f7", [0, 1, 2, 3, 4, 5, 6, 7, 8]);
    design.addPosition("g7", [0, 0, -3, 21, 21, 0, 6, 0, 0]);
    design.addPosition("a6", [0, 1, 2, 3, 4, 5, 6, 7, 8]);
    design.addPosition("b6", [0, 2, 0, 14, 14, 0, 0, -8, 8]);
    design.addPosition("c6", [0, 1, 2, 3, 4, 5, 6, 7, 8]);
    design.addPosition("d6", [-7, 2, -2, 7, 7, 0, 0, 0, 0]);
    design.addPosition("e6", [0, 1, 2, 3, 4, 5, 6, 7, 8]);
    design.addPosition("f6", [0, 0, -2, 14, 14, -6, 6, 0, 0]);
    design.addPosition("g6", [0, 1, 2, 3, 4, 5, 6, 7, 8]);
    design.addPosition("a5", [0, 1, 2, 3, 4, 5, 6, 7, 8]);
    design.addPosition("b5", [0, 1, 2, 3, 4, 5, 6, 7, 8]);
    design.addPosition("c5", [0, 1, 0, 7, 7, 0, 0, -8, 0]);
    design.addPosition("d5", [-7, 1, -1, 0, 14, 0, 0, 0, 0]);
    design.addPosition("e5", [0, 0, -1, 7, 7, -6, 0, 0, 0]);
    design.addPosition("f5", [0, 1, 2, 3, 4, 5, 6, 7, 8]);
    design.addPosition("g5", [0, 1, 2, 3, 4, 5, 6, 7, 8]);
    ...
    design.addPosition("d4", [0, 1, 2, 3, 4, 5, 6, 7, 8]);
    ...
    design.addPosition("c2", [0, 1, 2, 3, 4, 5, 6, 7, 8]);
    design.addPosition("d2", [-7, 2, -2, 7, 7, 0, 0, 0, 0]);
    design.addPosition("e2", [0, 1, 2, 3, 4, 5, 6, 7, 8]);
    ...
    design.addPosition("c1", [0, 1, 2, 3, 4, 5, 6, 7, 8]);
    design.addPosition("d1", [-7, 3, -3, 0, -27, 0, 0, 0, 0]);
    design.addPosition("e1", [0, 1, 2, 3, 4, 5, 6, 7, 8]);
