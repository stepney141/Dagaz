...
//  design.checkVersion("ko", "situation");
    ...
    design.addPosition("c7", [0, 1, 2, 3, 4]);
    design.addPosition("d7", [0, 3, -3, 7, 7]);
    design.addPosition("e7", [0, 1, 2, 3, 4]);
    design.addPosition("f7", [0, 1, 2, 3, 4]);
    ...
    design.addPosition("d6", [-7, 2, -2, 7, 7]);
    design.addPosition("e6", [0, 1, 2, 3, 4]);
    design.addPosition("f6", [0, 0, -2, 14, 14]);
    design.addPosition("g6", [0, 1, 2, 3, 4]);
    design.addPosition("a5", [0, 1, 2, 3, 4]);
    design.addPosition("b5", [0, 1, 2, 3, 4]);
    design.addPosition("c5", [0, 1, 0, 7, 7]);
    design.addPosition("d5", [-7, 1, -1, 0, 14]);
    design.addPosition("e5", [0, 0, -1, 7, 7]);
    design.addPosition("f5", [0, 1, 2, 3, 4]);
    design.addPosition("g5", [0, 1, 2, 3, 4]);
    design.addPosition("a4", [-21, 1, 0, 21, 21]);
    design.addPosition("b4", [-14, 1, -1, 14, 14]);
    design.addPosition("c4", [-7, 0, -1, 7, 7]);
    design.addPosition("d4", [0, 1, 2, 3, 4]);
    design.addPosition("e4", [-7, 1, 0, 7, 7]);
    design.addPosition("f4", [-14, 1, -1, 14, 14]);
    design.addPosition("g4", [-21, 0, -1, 21, 21]);
    design.addPosition("a3", [0, 1, 2, 3, 4]);
    design.addPosition("b3", [0, 1, 2, 3, 4]);
    design.addPosition("c3", [-7, 1, 0, 0, -27]);
    design.addPosition("d3", [0, 1, -1, 7, 7]);
    design.addPosition("e3", [-7, 0, -1, 0, -20]);
    design.addPosition("f3", [0, 1, 2, 3, 4]);
    design.addPosition("g3", [0, 1, 2, 3, 4]);
    design.addPosition("a2", [0, 1, 2, 3, 4]);
    design.addPosition("b2", [-14, 2, 0, 0, -20]);
    design.addPosition("c2", [0, 1, 2, 3, 4]);
    design.addPosition("d2", [-7, 2, -2, 7, 7]);
    design.addPosition("e2", [0, 1, 2, 3, 4]);
    design.addPosition("f2", [-14, 0, -2, 0, -34]);
    design.addPosition("g2", [0, 1, 2, 3, 4]);
    design.addPosition("a1", [-21, 3, 0, 0, -34]);
    design.addPosition("b1", [0, 1, 2, 3, 4]);
    design.addPosition("c1", [0, 1, 2, 3, 4]);
    design.addPosition("d1", [-7, 3, -3, 0, -27]);
    design.addPosition("e1", [0, 1, 2, 3, 4]);
    design.addPosition("f1", [0, 1, 2, 3, 4]);
