...
Dagaz.Model.CheckInvariants = function(board) {
  ...
  if (promote.length == 0) {
      ...
      promote[ design.getPieceType("KnightP") ] = design.getPieceType("Knight");
      promote[ design.getPieceType("LanceP") ]  = design.getPieceType("Lance");
      promote[ design.getPieceType("BishopP") ] = design.getPieceType("Bishop");
      promote[ design.getPieceType("RookP") ]   = design.getPieceType("Rook");
