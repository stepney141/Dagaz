...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addPiece("Knight", 0, 8);
    design.addMove(0, 0, [7, 6], 0);
    design.addMove(0, 0, [7, 5], 0);
    design.addMove(0, 0, [1, 2], 0);
    design.addMove(0, 0, [1, 0], 0);
    design.addMove(0, 0, [4, 6], 0);
    design.addMove(0, 0, [4, 2], 0);
    design.addMove(0, 0, [3, 5], 0);
    ...
    design.setup("Black", "Chariot-Soldier", 146);
    design.setup("Black", "Water-Buffalo", 153);
    design.setup("Black", "Lion", 148);
    design.setup("Black", "Fire-Demon", 149);
    design.setup("Black", "Queen", 150);
    design.setup("Black", "Phoenix", 152);
    design.setup("Black", "Side-Soldier", 130);
    design.setup("Black", "Side-Soldier", 142);
    design.setup("Black", "Rook", 131);
    design.setup("Black", "Rook", 141);
    design.setup("Black", "Bishop", 132);
    design.setup("Black", "Bishop", 140);
    ...
    design.setup("White", "Chariot-Soldier", 22);
    design.setup("White", "Water-Buffalo", 15);
    design.setup("White", "Lion", 20);
    design.setup("White", "Fire-Demon", 19);
    design.setup("White", "Queen", 18);
    design.setup("White", "Phoenix", 16);
    design.setup("White", "Side-Soldier", 26);
    design.setup("White", "Side-Soldier", 38);
    design.setup("White", "Rook", 27);
    design.setup("White", "Rook", 37);
    design.setup("White", "Bishop", 28);
    design.setup("White", "Bishop", 36);
