...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addPlayer("Black", [3, 2, 1, 0, 4]);
    design.addPlayer("White", [0, 1, 2, 3, 4]);

    design.addPosition("a1", [14, 1, 0, 0, 0]);
    design.addPosition("b1", [14, 1, -1, 0, 0]);
    design.addPosition("c1", [14, 1, -1, 0, 0]);
    design.addPosition("d1", [14, 1, -1, 0, 0]);
    design.addPosition("e1", [14, 1, -1, 0, 0]);
    design.addPosition("f1", [14, 1, -1, 0, 0]);
    design.addPosition("g1", [14, 1, -1, 0, 0]);
    design.addPosition("h1", [14, 1, -1, 0, 0]);
    design.addPosition("i1", [14, 1, -1, 0, 0]);
    design.addPosition("j1", [14, 1, -1, 0, 0]);
    design.addPosition("k1", [14, 1, -1, 0, 0]);
    design.addPosition("l1", [14, 1, -1, 0, 0]);
    design.addPosition("m1", [14, 1, -1, 0, 0]);
    design.addPosition("n1", [14, 0, -1, 0, 0]);
    design.addPosition("a2", [14, 1, 0, -14, 0]);
    design.addPosition("b2", [14, 1, -1, -14, 0]);
    design.addPosition("c2", [14, 1, -1, -14, 0]);
    design.addPosition("d2", [14, 1, -1, -14, 0]);
    design.addPosition("e2", [14, 1, -1, -14, 0]);
    design.addPosition("f2", [14, 1, -1, -14, 0]);
    design.addPosition("g2", [14, 1, -1, -14, 0]);
    design.addPosition("h2", [14, 1, -1, -14, 0]);
    design.addPosition("i2", [14, 1, -1, -14, 0]);
    design.addPosition("j2", [14, 1, -1, -14, 0]);
    design.addPosition("k2", [14, 1, -1, -14, 0]);
    design.addPosition("l2", [14, 1, -1, -14, 0]);
    design.addPosition("m2", [14, 1, -1, -14, 0]);
    design.addPosition("n2", [14, 0, -1, -14, 0]);
    design.addPosition("a3", [14, 1, 0, -14, 0]);
    design.addPosition("b3", [14, 1, -1, -14, 0]);
    design.addPosition("c3", [14, 1, -1, -14, 0]);
    design.addPosition("d3", [14, 1, -1, -14, 0]);
    design.addPosition("e3", [14, 1, -1, -14, 0]);
    design.addPosition("f3", [14, 1, -1, -14, 0]);
    design.addPosition("g3", [14, 1, -1, -14, 0]);
    design.addPosition("h3", [14, 1, -1, -14, 0]);
    design.addPosition("i3", [14, 1, -1, -14, 0]);
    design.addPosition("j3", [14, 1, -1, -14, 0]);
    design.addPosition("k3", [14, 1, -1, -14, 0]);
    design.addPosition("l3", [14, 1, -1, -14, 0]);
    design.addPosition("m3", [14, 1, -1, -14, 0]);
    design.addPosition("n3", [14, 0, -1, -14, 0]);
    design.addPosition("a4", [14, 1, 0, -14, 0]);
    design.addPosition("b4", [14, 1, -1, -14, 0]);
    design.addPosition("c4", [14, 1, -1, -14, 0]);
    design.addPosition("d4", [14, 1, -1, -14, 0]);
    design.addPosition("e4", [14, 1, -1, -14, 0]);
    design.addPosition("f4", [14, 1, -1, -14, 0]);
    design.addPosition("g4", [14, 1, -1, -14, 0]);
    design.addPosition("h4", [14, 1, -1, -14, 0]);
    design.addPosition("i4", [14, 1, -1, -14, 0]);
    design.addPosition("j4", [14, 1, -1, -14, 0]);
    design.addPosition("k4", [14, 1, -1, -14, 0]);
    design.addPosition("l4", [14, 1, -1, -14, 0]);
    design.addPosition("m4", [14, 1, -1, -14, 0]);
    design.addPosition("n4", [14, 0, -1, -14, 0]);
    design.addPosition("a5", [14, 1, 0, -14, 0]);
    design.addPosition("b5", [14, 1, -1, -14, 0]);
    design.addPosition("c5", [14, 1, -1, -14, 0]);
    design.addPosition("d5", [14, 1, -1, -14, 0]);
    design.addPosition("e5", [14, 1, -1, -14, 0]);
    design.addPosition("f5", [14, 1, -1, -14, 0]);
    design.addPosition("g5", [14, 1, -1, -14, 0]);
    design.addPosition("h5", [14, 1, -1, -14, 0]);
    design.addPosition("i5", [14, 1, -1, -14, 0]);
    design.addPosition("j5", [14, 1, -1, -14, 0]);
    design.addPosition("k5", [14, 1, -1, -14, 0]);
    design.addPosition("l5", [14, 1, -1, -14, 0]);
    design.addPosition("m5", [14, 1, -1, -14, 0]);
    design.addPosition("n5", [14, 0, -1, -14, 0]);
    design.addPosition("a6", [14, 1, 0, -14, 0]);
    design.addPosition("b6", [14, 1, -1, -14, 0]);
    design.addPosition("c6", [14, 1, -1, -14, 0]);
    design.addPosition("d6", [14, 1, -1, -14, 0]);
    design.addPosition("e6", [14, 1, -1, -14, 0]);
    design.addPosition("f6", [14, 1, -1, -14, 0]);
    design.addPosition("g6", [14, 1, -1, -14, 0]);
    design.addPosition("h6", [14, 1, -1, -14, 0]);
    design.addPosition("i6", [14, 1, -1, -14, 0]);
    design.addPosition("j6", [14, 1, -1, -14, 0]);
    design.addPosition("k6", [14, 1, -1, -14, 0]);
    design.addPosition("l6", [14, 1, -1, -14, 0]);
    design.addPosition("m6", [14, 1, -1, -14, 0]);
    design.addPosition("n6", [14, 0, -1, -14, 0]);
    design.addPosition("a7", [14, 1, 0, -14, 0]);
    design.addPosition("b7", [14, 1, -1, -14, 0]);
    design.addPosition("c7", [14, 1, -1, -14, 0]);
    design.addPosition("d7", [14, 1, -1, -14, 0]);
    design.addPosition("e7", [14, 1, -1, -14, 0]);
    design.addPosition("f7", [14, 1, -1, -14, 0]);
    design.addPosition("g7", [14, 1, -1, -14, 15]);
    design.addPosition("h7", [14, 1, -1, -14, 0]);
    design.addPosition("i7", [14, 1, -1, -14, 0]);
    design.addPosition("j7", [14, 1, -1, -14, 0]);
    design.addPosition("k7", [14, 1, -1, -14, 0]);
    design.addPosition("l7", [14, 1, -1, -14, 0]);
    design.addPosition("m7", [14, 1, -1, -14, 0]);
    design.addPosition("n7", [14, 0, -1, -14, 0]);
    design.addPosition("a8", [14, 1, 0, -14, 0]);
    design.addPosition("b8", [14, 1, -1, -14, 0]);
    design.addPosition("c8", [14, 1, -1, -14, 0]);
    design.addPosition("d8", [14, 1, -1, -14, 0]);
    design.addPosition("e8", [14, 1, -1, -14, 0]);
    design.addPosition("f8", [14, 1, -1, -14, 0]);
    design.addPosition("g8", [14, 1, -1, -14, 0]);
    design.addPosition("h8", [14, 1, -1, -14, -15]);
    design.addPosition("i8", [14, 1, -1, -14, 0]);
    design.addPosition("j8", [14, 1, -1, -14, 0]);
    design.addPosition("k8", [14, 1, -1, -14, 0]);
    design.addPosition("l8", [14, 1, -1, -14, 0]);
    design.addPosition("m8", [14, 1, -1, -14, 0]);
    design.addPosition("n8", [14, 0, -1, -14, 0]);
    design.addPosition("a9", [14, 1, 0, -14, 0]);
    design.addPosition("b9", [14, 1, -1, -14, 0]);
    design.addPosition("c9", [14, 1, -1, -14, 0]);
    design.addPosition("d9", [14, 1, -1, -14, 0]);
    design.addPosition("e9", [14, 1, -1, -14, 0]);
    design.addPosition("f9", [14, 1, -1, -14, 0]);
    design.addPosition("g9", [14, 1, -1, -14, 0]);
    design.addPosition("h9", [14, 1, -1, -14, 0]);
    design.addPosition("i9", [14, 1, -1, -14, 0]);
    design.addPosition("j9", [14, 1, -1, -14, 0]);
    design.addPosition("k9", [14, 1, -1, -14, 0]);
    design.addPosition("l9", [14, 1, -1, -14, 0]);
    design.addPosition("m9", [14, 1, -1, -14, 0]);
    design.addPosition("n9", [14, 0, -1, -14, 0]);
    design.addPosition("a10", [14, 1, 0, -14, 0]);
    design.addPosition("b10", [14, 1, -1, -14, 0]);
    design.addPosition("c10", [14, 1, -1, -14, 0]);
    design.addPosition("d10", [14, 1, -1, -14, 0]);
    design.addPosition("e10", [14, 1, -1, -14, 0]);
    design.addPosition("f10", [14, 1, -1, -14, 0]);
    design.addPosition("g10", [14, 1, -1, -14, 0]);
    design.addPosition("h10", [14, 1, -1, -14, 0]);
    design.addPosition("i10", [14, 1, -1, -14, 0]);
    design.addPosition("j10", [14, 1, -1, -14, 0]);
    design.addPosition("k10", [14, 1, -1, -14, 0]);
    design.addPosition("l10", [14, 1, -1, -14, 0]);
    design.addPosition("m10", [14, 1, -1, -14, 0]);
    design.addPosition("n10", [14, 0, -1, -14, 0]);
    design.addPosition("a11", [14, 1, 0, -14, 0]);
    design.addPosition("b11", [14, 1, -1, -14, 0]);
    design.addPosition("c11", [14, 1, -1, -14, 0]);
    design.addPosition("d11", [14, 1, -1, -14, 0]);
    design.addPosition("e11", [14, 1, -1, -14, 0]);
    design.addPosition("f11", [14, 1, -1, -14, 0]);
    design.addPosition("g11", [14, 1, -1, -14, 0]);
    design.addPosition("h11", [14, 1, -1, -14, 0]);
    design.addPosition("i11", [14, 1, -1, -14, 0]);
    design.addPosition("j11", [14, 1, -1, -14, 0]);
    design.addPosition("k11", [14, 1, -1, -14, 0]);
    design.addPosition("l11", [14, 1, -1, -14, 0]);
    design.addPosition("m11", [14, 1, -1, -14, 0]);
    design.addPosition("n11", [14, 0, -1, -14, 0]);
    design.addPosition("a12", [14, 1, 0, -14, 0]);
    design.addPosition("b12", [14, 1, -1, -14, 0]);
    design.addPosition("c12", [14, 1, -1, -14, 0]);
    design.addPosition("d12", [14, 1, -1, -14, 0]);
    design.addPosition("e12", [14, 1, -1, -14, 0]);
    design.addPosition("f12", [14, 1, -1, -14, 0]);
    design.addPosition("g12", [14, 1, -1, -14, 0]);
    design.addPosition("h12", [14, 1, -1, -14, 0]);
    design.addPosition("i12", [14, 1, -1, -14, 0]);
    design.addPosition("j12", [14, 1, -1, -14, 0]);
    design.addPosition("k12", [14, 1, -1, -14, 0]);
    design.addPosition("l12", [14, 1, -1, -14, 0]);
    design.addPosition("m12", [14, 1, -1, -14, 0]);
    design.addPosition("n12", [14, 0, -1, -14, 0]);
    design.addPosition("a13", [14, 1, 0, -14, 0]);
    design.addPosition("b13", [14, 1, -1, -14, 0]);
    design.addPosition("c13", [14, 1, -1, -14, 0]);
    design.addPosition("d13", [14, 1, -1, -14, 0]);
    design.addPosition("e13", [14, 1, -1, -14, 0]);
    design.addPosition("f13", [14, 1, -1, -14, 0]);
    design.addPosition("g13", [14, 1, -1, -14, 0]);
    design.addPosition("h13", [14, 1, -1, -14, 0]);
    design.addPosition("i13", [14, 1, -1, -14, 0]);
    design.addPosition("j13", [14, 1, -1, -14, 0]);
    design.addPosition("k13", [14, 1, -1, -14, 0]);
    design.addPosition("l13", [14, 1, -1, -14, 0]);
    design.addPosition("m13", [14, 1, -1, -14, 0]);
    design.addPosition("n13", [14, 0, -1, -14, 0]);
    design.addPosition("a14", [0, 1, 0, -14, 0]);
    design.addPosition("b14", [0, 1, -1, -14, 0]);
    design.addPosition("c14", [0, 1, -1, -14, 0]);
    design.addPosition("d14", [0, 1, -1, -14, 0]);
    design.addPosition("e14", [0, 1, -1, -14, 0]);
    design.addPosition("f14", [0, 1, -1, -14, 0]);
    design.addPosition("g14", [0, 1, -1, -14, 0]);
    design.addPosition("h14", [0, 1, -1, -14, 0]);
    design.addPosition("i14", [0, 1, -1, -14, 0]);
    design.addPosition("j14", [0, 1, -1, -14, 0]);
    design.addPosition("k14", [0, 1, -1, -14, 0]);
    design.addPosition("l14", [0, 1, -1, -14, 0]);
    ...
    design.addCommand(2, ZRF.FUNCTION,	1);	// empty?
    design.addCommand(2, ZRF.FUNCTION,	20);	// verify
    design.addCommand(2, ZRF.MODE,	3);	// step-type
