...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addPosition("a8", [0, 1, 7, 0]);
    design.addPosition("b8", [-1, 1, 7, 0]);
    design.addPosition("c8", [-1, 1, 7, 0]);
    design.addPosition("d8", [-1, 1, 7, 0]);
    design.addPosition("e8", [-1, 1, 7, 0]);
    design.addPosition("f8", [-1, 1, 7, 0]);
    design.addPosition("g8", [-1, 0, 7, 0]);
