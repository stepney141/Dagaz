...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.checkVersion("mancala-ai", "simple");
    design.checkVersion("dakon-extension", "simple");
    ...
    design.addPlayer("North", [1, 0, 3, 2, 5, 4, 7, 6]);

    design.addPosition("a2", [6, 13, 12, 13, 0, 6, 1, 1]);
    design.addPosition("b2", [-1, -1, 0, 0, 0, 6, 1, 1]);
    design.addPosition("c2", [-1, -1, 0, 0, 0, 6, 1, 1]);
    design.addPosition("d2", [-1, -1, 0, 0, 0, 6, 1, 1]);
    design.addPosition("e2", [-1, -1, 0, 0, 0, 6, 1, 1]);
    design.addPosition("f2", [-1, -1, 0, 0, 0, 6, 7, 6]);
    design.addPosition("a1", [1, 1, 0, 0, -6, 0, -6, 7]);
    design.addPosition("b1", [1, 1, 0, 0, -6, 0, -1, -1]);
    design.addPosition("c1", [1, 1, 0, 0, -6, 0, -1, -1]);
    design.addPosition("d1", [1, 1, 0, 0, -6, 0, -1, -1]);
    design.addPosition("e1", [1, 1, 0, 0, -6, 0, -1, -1]);
    design.addPosition("f1", [1, -6, 0, 0, -6, 0, -1, -1]);
    design.addPosition("X1", [-7, 0, 0, 0, 0, 0, -1, 0]);
    design.addPosition("X2", [0, -7, 0, 0, 0, 0, 0, -13]);

    design.addZone("home", 1, [6, 7, 8, 9, 10, 11]);
    design.addZone("home", 2, [0, 1, 2, 3, 4, 5]);
    design.addZone("pool", 1, [12, 13]);
    design.addZone("pool", 2, [12, 13]);
