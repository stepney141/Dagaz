...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addPlayer("North", [0, 2, 1, 3]);

    design.addPosition("a3", [6, 18, 19, 12]);
    design.addPosition("b3", [-1, 0, 0, 12]);
    design.addPosition("c3", [-1, 0, 0, 12]);
    design.addPosition("d3", [-1, 0, 0, 12]);
    design.addPosition("e3", [-1, 0, 0, 12]);
    design.addPosition("f3", [-1, 0, 0, 12]);
    design.addPosition("a2", [1, 0, 0, -6]);
    design.addPosition("b2", [1, 0, 0, -6]);
    design.addPosition("c2", [4, 0, 0, -6]);
    design.addPosition("d2", [-4, 0, 0, -6]);
    design.addPosition("e2", [-1, 0, 0, -6]);
    design.addPosition("f2", [-1, 0, 0, -6]);
    design.addPosition("a1", [1, 0, 0, -6]);
    design.addPosition("b1", [1, 0, 0, -6]);
    design.addPosition("c1", [1, 0, 0, -6]);
    design.addPosition("d1", [1, 0, 0, -6]);
    design.addPosition("e1", [1, 0, 0, -6]);
    design.addPosition("f1", [-6, 0, 0, -6]);
