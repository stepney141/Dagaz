...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a13", 0, 7, 91, 43);
    view.defPosition("a12", 0, 50, 91, 43);
    view.defPosition("a11", 0, 93, 91, 43);
    view.defPosition("a10", 0, 136, 91, 43);
    view.defPosition("a9", 0, 179, 91, 43);
    view.defPosition("a8", 0, 222, 91, 43);
    view.defPosition("b13", 86, 7, 91, 43);
    view.defPosition("b12", 86, 50, 91, 43);
    view.defPosition("b11", 86, 93, 91, 43);
    view.defPosition("b10", 86, 136, 91, 43);
    view.defPosition("b9", 86, 179, 91, 43);
    view.defPosition("b8", 86, 222, 91, 43);
    view.defPosition("c13", 182, 7, 91, 43);
    view.defPosition("c12", 182, 50, 91, 43);
    view.defPosition("c11", 182, 93, 91, 43);
    view.defPosition("c10", 182, 136, 91, 43);
    view.defPosition("c9", 182, 179, 91, 43);
    view.defPosition("c8", 182, 222, 91, 43);
    view.defPosition("d13", 277, 7, 91, 43);
    view.defPosition("d12", 277, 50, 91, 43);
    view.defPosition("d11", 277, 93, 91, 43);
    view.defPosition("d10", 277, 136, 91, 43);
    view.defPosition("d9", 277, 179, 91, 43);
    view.defPosition("d8", 277, 222, 91, 43);
    view.defPosition("e13", 362, 7, 91, 43);
    view.defPosition("e12", 362, 50, 91, 43);
    view.defPosition("e11", 362, 93, 91, 43);
    view.defPosition("e10", 362, 136, 91, 43);
    view.defPosition("e9", 362, 179, 91, 43);
    view.defPosition("e8", 362, 222, 91, 43);
    view.defPosition("a7", 0, 284, 91, 43);
    view.defPosition("c7", 182, 284, 91, 43);
    view.defPosition("e7", 362, 284, 91, 43);
    view.defPosition("a6", 0, 347, 91, 43);
    view.defPosition("a5", 0, 390, 91, 43);
    view.defPosition("a4", 0, 433, 91, 43);
    view.defPosition("a3", 0, 476, 91, 43);
    view.defPosition("a2", 0, 519, 91, 43);
    view.defPosition("a1", 0, 561, 91, 43);
    view.defPosition("b6", 86, 347, 91, 43);
    view.defPosition("b5", 86, 390, 91, 43);
    view.defPosition("b4", 86, 433, 91, 43);
    view.defPosition("b3", 86, 476, 91, 43);
    view.defPosition("b2", 86, 519, 91, 43);
    view.defPosition("b1", 86, 561, 91, 43);
    view.defPosition("c6", 182, 347, 91, 43);
    view.defPosition("c5", 182, 390, 91, 43);
    view.defPosition("c4", 182, 433, 91, 43);
    view.defPosition("c3", 182, 476, 91, 43);
    view.defPosition("c2", 182, 519, 91, 43);
    view.defPosition("c1", 182, 561, 91, 43);
    view.defPosition("d6", 276, 347, 91, 43);
    view.defPosition("d5", 276, 390, 91, 43);
    view.defPosition("d4", 276, 433, 91, 43);
    view.defPosition("d3", 276, 476, 91, 43);
    view.defPosition("d2", 276, 519, 91, 43);
    view.defPosition("d1", 276, 561, 91, 43);
    view.defPosition("e6", 362, 347, 91, 43);
    view.defPosition("e5", 362, 390, 91, 43);
    view.defPosition("e4", 362, 433, 91, 43);
    view.defPosition("e3", 362, 476, 91, 43);
    view.defPosition("e2", 362, 519, 91, 43);
    view.defPosition("e1", 362, 561, 91, 43);
}
