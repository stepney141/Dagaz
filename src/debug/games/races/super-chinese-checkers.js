...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addPosition("g13", [0, 0, 0, 0, 0, 0]);
    design.addPosition("h13", [0, 0, 0, 0, 0, 0]);
    design.addPosition("i13", [0, 0, 0, 0, 0, 0]);
    design.addPosition("j13", [0, 0, 0, 0, 0, 0]);
    design.addPosition("k13", [0, 0, 0, 0, 0, 0]);
    design.addPosition("l13", [0, 0, 0, 0, 0, 0]);
    design.addPosition("m13", [0, 0, 0, 0, 0, 0]);
    ...
    design.addPosition("g12", [0, 0, 0, 0, 0, 0]);
    design.addPosition("h12", [0, 0, 0, 0, 0, 0]);
    design.addPosition("i12", [0, 0, 0, 0, 0, 0]);
    design.addPosition("j12", [0, 0, 0, 0, 0, 0]);
    design.addPosition("k12", [0, 0, 0, 0, 0, 0]);
    design.addPosition("l12", [0, 0, 0, 0, 0, 0]);
    design.addPosition("m12", [0, 0, 0, 0, 0, 0]);
    ...
    design.addPosition("j11", [0, 0, 0, 0, 0, 0]);
    design.addPosition("k11", [0, 0, 0, 0, 0, 0]);
    design.addPosition("l11", [0, 0, 0, 0, 0, 0]);
    design.addPosition("m11", [0, 0, 0, 0, 0, 0]);
    ...
    design.addPosition("k10", [0, 0, 0, 0, 0, 0]);
    design.addPosition("l10", [0, 0, 0, 0, 0, 0]);
    design.addPosition("m10", [0, 0, 0, 0, 0, 0]);
    ...
    design.addMove(0, 2, [4, 4, 4, 4], 1);
    design.addMove(0, 2, [3, 3, 3, 3], 1);
    design.addMove(0, 2, [1, 1, 1, 1], 1);
    design.addMove(0, 2, [0, 0, 0, 0], 1);
    design.addMove(0, 3, [5, 5, 5, 5, 5, 5], 1);
    design.addMove(0, 3, [2, 2, 2, 2, 2, 2], 1);
    design.addMove(0, 3, [4, 4, 4, 4, 4, 4], 1);
    design.addMove(0, 3, [3, 3, 3, 3, 3, 3], 1);
    design.addMove(0, 3, [1, 1, 1, 1, 1, 1], 1);
    design.addMove(0, 3, [0, 0, 0, 0, 0, 0], 1);
    design.addMove(0, 4, [5, 5, 5, 5, 5, 5, 5, 5], 1);
    design.addMove(0, 4, [2, 2, 2, 2, 2, 2, 2, 2], 1);
    design.addMove(0, 4, [4, 4, 4, 4, 4, 4, 4, 4], 1);
    design.addMove(0, 4, [3, 3, 3, 3, 3, 3, 3, 3], 1);
    design.addMove(0, 4, [1, 1, 1, 1, 1, 1, 1, 1], 1);
    design.addMove(0, 4, [0, 0, 0, 0, 0, 0, 0, 0], 1);
