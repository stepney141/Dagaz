...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addPosition("x3", [0, 1]);
    design.addPosition("x4", [0, 1]);
    design.addPosition("y1", [0, 1]);
    design.addPosition("y2", [0, 1]);
    design.addPosition("y3", [0, 1]);
    design.addPosition("y4", [0, 1]);
