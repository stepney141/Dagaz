...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("White", "Man", 170);
    design.setup("White", "Man", 171);
    design.setup("White", "Man", 0);
    design.setup("White", "Man", 1);
    design.setup("White", "Man", 2);
    design.setup("White", "Man", 3);
    design.setup("White", "Man", 306);
    design.setup("White", "Man", 307);
    design.setup("White", "Man", 308);
    design.setup("White", "Man", 309);
    design.setup("White", "Man", 272);
    design.setup("White", "Man", 273);
    design.setup("White", "Man", 274);
    design.setup("Black", "Man", 391);
    design.setup("Black", "Man", 392);
    design.setup("Black", "Man", 374);
    design.setup("Black", "Man", 375);
