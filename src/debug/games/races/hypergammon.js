...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addPosition("m1", [34, 33, 26, 12, 1]);
    ...
    design.addPosition("B5", [0, -1, 1, -18, -6]);
    design.addPosition("B4", [0, -1, 1, -19, -7]);
    design.addPosition("B3", [0, -1, 1, -20, -8]);
    design.addPosition("B2", [0, -1, 1, -21, -9]);
    design.addPosition("B1", [0, -1, 0, -22, -10]);
...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("B8", 210, 40, 30, 30);
    view.defPosition("B7", 210, 70, 30, 30);
    view.defPosition("B6", 210, 100, 30, 30);
    view.defPosition("B5", 210, 130, 30, 30);
    view.defPosition("B4", 210, 160, 30, 30);
    view.defPosition("B3", 210, 190, 30, 30);
    view.defPosition("B2", 210, 220, 30, 30);
    view.defPosition("B1", 210, 250, 30, 30);
