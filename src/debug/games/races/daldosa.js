...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addMove(1, 2, [0, 0], 2);
    design.addMove(1, 3, [0, 0, 0], 3);
    design.addMove(1, 4, [0, 0, 0, 0], 4);

    design.addPiece("D1", 2, 1);
    design.addDrop(2, 5, [], 0);

    design.addPiece("D2", 3, 2);
    design.addDrop(3, 5, [], 0);

    design.addPiece("D3", 4, 3);
    design.addDrop(4, 5, [], 0);

    design.addPiece("D4", 5, 4);
    design.addDrop(5, 5, [], 0);
...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a3", 19, 13, 29, 30);
    view.defPosition("a2", 19, 42, 29, 30);
    view.defPosition("a1", 19, 71, 29, 30);
    view.defPosition("b3", 48, 13, 29, 30);
    view.defPosition("b2", 48, 42, 29, 30);
    view.defPosition("b1", 48, 71, 29, 30);
    view.defPosition("c3", 77, 13, 29, 30);
    view.defPosition("c2", 78, 42, 28, 30);
    view.defPosition("c1", 77, 71, 29, 30);
    view.defPosition("d3", 107, 13, 29, 30);
    view.defPosition("d2", 106, 42, 29, 30);
    view.defPosition("d1", 106, 71, 29, 30);
    view.defPosition("e3", 136, 13, 29, 30);
    view.defPosition("e2", 135, 42, 29, 30);
    view.defPosition("e1", 135, 71, 29, 30);
    view.defPosition("f3", 164, 13, 29, 30);
    view.defPosition("f2", 164, 42, 29, 30);
    view.defPosition("f1", 164, 71, 29, 30);
    view.defPosition("g3", 194, 13, 29, 30);
    view.defPosition("g2", 193, 42, 29, 30);
    view.defPosition("g1", 193, 71, 29, 30);
    view.defPosition("h3", 223, 13, 29, 30);
    view.defPosition("h2", 223, 42, 29, 30);
    view.defPosition("h1", 223, 71, 29, 30);
    view.defPosition("i3", 252, 13, 29, 30);
    view.defPosition("i2", 252, 42, 29, 30);
    view.defPosition("i1", 252, 71, 29, 30);
    view.defPosition("j3", 281, 13, 29, 30);
    view.defPosition("j2", 281, 42, 29, 30);
    view.defPosition("j1", 281, 71, 29, 30);
    view.defPosition("k3", 310, 13, 29, 30);
    view.defPosition("k2", 310, 42, 29, 30);
    view.defPosition("k1", 310, 71, 29, 30);
    view.defPosition("l3", 339, 14, 29, 30);
    view.defPosition("l2", 339, 43, 29, 30);
    view.defPosition("l1", 339, 72, 29, 30);
    view.defPosition("m3", 368, 13, 29, 30);
    view.defPosition("m2", 368, 43, 29, 30);
    view.defPosition("m1", 368, 72, 29, 30);
    view.defPosition("n3", 397, 14, 29, 30);
    view.defPosition("n2", 397, 43, 29, 30);
    view.defPosition("n1", 397, 72, 29, 30);
    view.defPosition("o3", 426, 14, 29, 30);
    view.defPosition("o2", 426, 43, 29, 30);
    view.defPosition("o1", 426, 72, 29, 30);
    view.defPosition("p3", 455, 14, 29, 30);
    view.defPosition("p2", 455, 43, 29, 30);
    view.defPosition("p1", 455, 72, 29, 30);
    view.defPosition("q2", 484, 43, 29, 30);
}
