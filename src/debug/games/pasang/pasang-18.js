...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("N", "Black", 98);
    design.setup("N", "Black", 76);
    design.setup("N", "Black", 54);
    design.setup("N", "Black", 32);
