...
QUnit.test( "More pieces", function( assert ) {
  ...
  assert.equal( board.moves[2].toString(), "c4 - b4 c5 - b5 d4 - c4", "c4 - b4 c5 - b5 d4 - c4");
  assert.equal( board.moves[3].toString(), "c4 - c3 c5 - c4 d4 - d3", "c4 - c3 c5 - c4 d4 - d3");
  assert.equal( board.moves[4].toString(), "c5 - b5 c4 - b4 d4 - c4", "c5 - b5 c4 - b4 d4 - c4");
  assert.equal( board.moves[5].toString(), "c5 - c4 - c3 d4 - d3", "c5 - c4 - c3 d4 - d3");
  ...
  board.generate();
  assert.equal( board.moves.length, 15, "15 moves generated");
  ...
  assert.equal( board.moves[5].toString(), "b4 - c4 b5 - c5 c4 - d4", "b4 - c4 b5 - c5 c4 - d4");
  assert.equal( board.moves[6].toString(), "b4 - a4 b5 - a5 c4 - b4", "b4 - a4 b5 - a5 c4 - b4");
  assert.equal( board.moves[7].toString(), "b4 - b3 b5 - b4 c4 - c3", "b4 - b3 b5 - b4 c4 - c3");
  assert.equal( board.moves[8].toString(), "e5 - d5 - c5 e4 - d4", "e5 - d5 - c5 e4 - d4");
  assert.equal( board.moves[9].toString(), "e5 - e4 d5 - d4 e4 - e3", "e5 - e4 d5 - d4 e4 - e3");
  assert.equal( board.moves[10].toString(), "d5 - c5 e5 - d5 e4 - d4", "d5 - c5 e5 - d5 e4 - d4");
  assert.equal( board.moves[11].toString(), "d5 - d4 e5 - e4 - e3", "d5 - d4 e5 - e4 - e3");
  assert.equal( board.moves[12].toString(), "b5 - c5 b4 - c4 - d4", "b5 - c5 b4 - c4 - d4");
  assert.equal( board.moves[13].toString(), "b5 - a5 b4 - a4 c4 - b4", "b5 - a5 b4 - a4 c4 - b4");
  assert.equal( board.moves[14].toString(), "b5 - b4 - b3 c4 - c3", "b5 - b4 - b3 c4 - c3");
...
QUnit.test( "Simple Move list", function( assert ) {
  ...
  assert.deepEqual( m.getPositions(), [], "No marked positions");
  ...
  assert.deepEqual( m.getAttacking(), [], "No attacked positions");
  m.setPosition(Dagaz.Model.stringToPos("d1"));
  var moves = m.getMoves();
  assert.equal( moves.length, 1, "1 moves generated");
  assert.equal( moves[0].toString(), "c1 - d1", "c1 - d1");

  m.setPosition(Dagaz.Model.stringToPos("a2"));
  assert.deepEqual( m.getPositions(), [ 21, 20, 15 ], "Marked positions");
  assert.deepEqual( m.getAttacking(), [], "No attacked positions");
  m.setPosition(Dagaz.Model.stringToPos("c1"));
  assert.deepEqual( m.getPositions(), [ 23, 21 ], "Marked positions");

  m.setPosition(Dagaz.Model.stringToPos("a3"));
  assert.deepEqual( m.getPositions(), [ 21, 20, 15 ], "Marked positions");
  var moves = m.getMoves();
  assert.equal( moves.length, 3, "3 moves generated");
  assert.equal( moves[0].toString(), "b2 - b1 a3 - a2 - a1", "b2 - b1 a3 - a2 - a1");
  assert.equal( moves[1].toString(), "a2 - a1 a3 - a2 b2 - b1", "a2 - a1 a3 - a2 b2 - b1");
  assert.equal( moves[2].toString(), "a3 - a2 - a1 b2 - b1", "a3 - a2 - a1 b2 - b1");
  m.setPosition(Dagaz.Model.stringToPos("a1"));
  var moves = m.getMoves();
  assert.equal( moves.length, 1, "1 moves generated");
  assert.equal( moves[0].toString(), "b2 - b1 a3 - a2 - a1", "b2 - b1 a3 - a2 - a1");
  assert.equal( m.getLevel(), 1, "Move list Level 1");
